...
/*
   useRef는 React에서 DOM 요소에 직접 접근하거나 컴포넌트 랜거링 간 상태 변화 없이 값을 저장하는데 사용된다.
   state와 다르게 값이 변경되어도 컴포넌트가 리랜더링, 초기화되지 않고 참조값을 유지한다.
   주로 DOM 요소 포커스나 스크롤 위치를 추천하거나 또는 이전값을 기억하는데 유용하다.
*/
